...
public class CommentController {
    ...
    public ResponseEntity<List<CommentDTO>> getAllCommentForPost(@PathVariable("postId") String postId,
                                                                 Principal principal){
        List<CommentDTO> commentDTOList = commentService.getAllCommensFortPost(Long.parseLong(postId))
                .stream()
